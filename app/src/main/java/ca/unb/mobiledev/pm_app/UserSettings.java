    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        changeIconButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ActivityCompat.requestPermissions(UserSettings.this,
        ...
        switch (requestCode) {
            case 1: {
                if (grantResults.length > 0
                    ...
                    Toast.makeText(UserSettings.this, "Permission denied to read your External storage", Toast.LENGTH_SHORT).show();
                }
            }
        }
    }
